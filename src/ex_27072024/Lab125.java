...
public class Lab125 {
    public static void main(String[] args) {
        ...
        // index - 0,1,2
        // length - 3
        System.out.println(marks[0]); // op- 0
        System.out.println(marks[1]); // op- 0
        System.out.println(marks[2]); // op- 0
        marks[0] = 91;
        marks[1] = 92;
        marks[2] = 93;
        ...
        //we can't write int i = 0; i<= weekdays.length; i++ as length is 4 and index is 3 max
        {
